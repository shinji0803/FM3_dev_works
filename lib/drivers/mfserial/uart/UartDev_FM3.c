...
static int32_t	UartDev_RxAvailable(uint32_t Ch);
...
static int32_t	UartDev_Ch0_RxAvailable(void);
...
static int32_t	UartDev_Ch1_RxAvailable(void);
...
static int32_t	UartDev_Ch2_RxAvailable(void);
...
static int32_t	UartDev_Ch3_RxAvailable(void);
...
static int32_t	UartDev_Ch4_RxAvailable(void);
...
static int32_t	UartDev_Ch5_RxAvailable(void);
...
static int32_t	UartDev_Ch6_RxAvailable(void);
...
static int32_t	UartDev_Ch7_RxAvailable(void);
...
/*0*/{{UART_BAUDRATE, UART_DATABITS, UART_STOPBITS, UART_PARITY, UART_BITODER, UartDev_NRZ_NORMAL, 0, UART_BUFSIZE},
      UartDev_Ch0_Init, UartDev_Ch0_UnInit, UartDev_Ch0_BufTx, UartDev_Ch0_BufRx, UartDev_Ch0_RxAvailable, UartDev_Ch0_BufFlush},

/*1*/{{UART_BAUDRATE, UART_DATABITS, UART_STOPBITS, UART_PARITY, UART_BITODER, UartDev_NRZ_NORMAL, 0, UART_BUFSIZE},
      UartDev_Ch1_Init, UartDev_Ch1_UnInit, UartDev_Ch1_BufTx, UartDev_Ch1_BufRx, UartDev_Ch1_RxAvailable, UartDev_Ch1_BufFlush},

/*2*/{{UART_BAUDRATE, UART_DATABITS, UART_STOPBITS, UART_PARITY, UART_BITODER, UartDev_NRZ_NORMAL, 0, UART_BUFSIZE},
      UartDev_Ch2_Init, UartDev_Ch2_UnInit, UartDev_Ch2_BufTx, UartDev_Ch2_BufRx, UartDev_Ch2_RxAvailable, UartDev_Ch2_BufFlush},

/*3*/{{UART_BAUDRATE, UART_DATABITS, UART_STOPBITS, UART_PARITY, UART_BITODER, UartDev_NRZ_NORMAL, 0, UART_BUFSIZE},
      UartDev_Ch3_Init, UartDev_Ch3_UnInit, UartDev_Ch3_BufTx, UartDev_Ch3_BufRx, UartDev_Ch3_RxAvailable, UartDev_Ch3_BufFlush},

/*4*/{{UART_BAUDRATE, UART_DATABITS, UART_STOPBITS, UART_PARITY, UART_BITODER, UartDev_NRZ_NORMAL, 0, UART_BUFSIZE},
      UartDev_Ch4_Init, UartDev_Ch4_UnInit, UartDev_Ch4_BufTx, UartDev_Ch4_BufRx, UartDev_Ch4_RxAvailable, UartDev_Ch4_BufFlush},

/*5*/{{UART_BAUDRATE, UART_DATABITS, UART_STOPBITS, UART_PARITY, UART_BITODER, UartDev_NRZ_NORMAL, 0, UART_BUFSIZE},
      UartDev_Ch5_Init, UartDev_Ch5_UnInit, UartDev_Ch5_BufTx, UartDev_Ch5_BufRx, UartDev_Ch5_RxAvailable, UartDev_Ch5_BufFlush},

/*6*/{{UART_BAUDRATE, UART_DATABITS, UART_STOPBITS, UART_PARITY, UART_BITODER, UartDev_NRZ_NORMAL, 0, UART_BUFSIZE},
      UartDev_Ch6_Init, UartDev_Ch6_UnInit, UartDev_Ch6_BufTx, UartDev_Ch6_BufRx, UartDev_Ch6_RxAvailable, UartDev_Ch6_BufFlush},

/*7*/{{UART_BAUDRATE, UART_DATABITS, UART_STOPBITS, UART_PARITY, UART_BITODER, UartDev_NRZ_NORMAL, 0, UART_BUFSIZE},
      UartDev_Ch7_Init, UartDev_Ch7_UnInit, UartDev_Ch7_BufTx, UartDev_Ch7_BufRx, UartDev_Ch7_RxAvailable, UartDev_Ch7_BufFlush},
};
...
static int32_t UartDev_RxAvailable(uint32_t Ch)
{
	...
	return UART_BUF_COUNT(p_info->pRxBuf);
}
