...
extern vector a; // accelerometer readings
extern vector m; // magnetometer readings
extern vector m_max; // maximum magnetometer values, used for calibration
extern vector m_min; // minimum magnetometer values, used for calibration
